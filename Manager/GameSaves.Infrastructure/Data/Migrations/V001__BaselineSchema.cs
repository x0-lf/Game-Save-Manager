...
{
    public sealed class V001__BaselineSchema : ISchemaMigration
    {
        public int Version => 1;
        public string Name => "V001__BaselineSchema";
        public string Description => "Initial baseline tables for save paths, verification, backup runs, and catalog.";
